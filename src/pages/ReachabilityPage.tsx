...
/**
 * Reachability calculation page. State is entirely local to this component;
 * mounting/unmounting it (tab switching) preserves that state because App
 * keeps every page mounted and only toggles visibility.
 */
